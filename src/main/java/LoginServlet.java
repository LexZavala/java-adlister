...
//        // set the dark theme attribute on the session so that it gets remembered on the session so that it
//        //gets remembered every time we log in.
//        session.setAttribute("darkMode", darkMode);
//
//        //on a different servlet (profile page).
//        // with our getAttribute method, our return is alwasy a generic Object type.
